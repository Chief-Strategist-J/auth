...
echo "==> [users-profile] GET /api/v1/auth/users/${TARGET_USER_ID}/permissions -> Get User Effective Permission Set"
curl -s -X GET "${AUTH_URL}/api/v1/auth/users/${TARGET_USER_ID}/permissions" \
