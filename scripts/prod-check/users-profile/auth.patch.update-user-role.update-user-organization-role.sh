...
echo "==> [users-profile] PATCH /api/v1/auth/users/${TARGET_USER_ID}/role -> Update User Organization Role"
curl -s -X PATCH "${AUTH_URL}/api/v1/auth/users/${TARGET_USER_ID}/role" \
