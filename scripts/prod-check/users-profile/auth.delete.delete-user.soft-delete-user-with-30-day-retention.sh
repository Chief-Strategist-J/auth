...
echo "==> [users-profile] DELETE /api/v1/auth/users/${TARGET_USER_ID} -> Soft Delete User with 30-Day Retention"
curl -s -X DELETE "${AUTH_URL}/api/v1/auth/users/${TARGET_USER_ID}" \
