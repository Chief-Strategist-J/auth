...
echo "==> [users-profile] PATCH /api/v1/auth/users/${TARGET_USER_ID}/permissions -> Update User Permission Entitlements"
curl -s -X PATCH "${AUTH_URL}/api/v1/auth/users/${TARGET_USER_ID}/permissions" \
