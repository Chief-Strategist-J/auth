...
echo "==> [users-profile] POST /api/v1/auth/users/${TARGET_USER_ID}/block -> Block User Access and Record Block Timestamp"
curl -s -X POST "${AUTH_URL}/api/v1/auth/users/${TARGET_USER_ID}/block" \
