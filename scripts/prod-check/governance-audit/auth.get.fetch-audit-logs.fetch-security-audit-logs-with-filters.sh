...
echo "==> [governance-audit] GET /api/v1/auth/audit-logs -> Fetch Security Audit Logs with Filters"
curl -s -X GET "${AUTH_URL}/api/v1/auth/audit-logs?event_type=${AUDIT_EVENT_TYPE}&from=${AUDIT_FROM}&to=${AUDIT_TO}" \
