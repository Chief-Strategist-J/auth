...
- **Solution / Fix**:
  1. Ensure `initOpenTelemetryTracer()` in `web-app/src/core/tracing/tracer.ts` dynamically imports `@chief-strategist-j/shared-infra/tracing` for Node.js server side.
